(() => {
  ...
  chrome.runtime.onMessage.addListener((message, _sender, sendResponse) => {
    ...
    switch (message && message.type) {
      case 'DUO_PING': sendResponse({ ok: true, installed: true, htmlBridgeVersion:'1.4.6', fullscreen:fullscreen.snapshot(), interaction:interactionSnapshot(), captions:entries.size, speechBuild: '20260906-chrome103-rca-echo' }); return;
