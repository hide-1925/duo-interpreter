...
const GATE=['test-turn-decision.cjs','test-file-sync.cjs','test-release-manifest.cjs','test-turn-trace-replay.cjs',
  ...
  'test-google-tts.cjs','test-one-touch.cjs','test-tts-skip.cjs','test-webspeech-punct.cjs','test-webspeech-track.cjs','test-aivis-prefetch.cjs','test-4o-tuning.cjs','test-model-tiers.cjs','test-model-hub.cjs','test-hub-tts.cjs','test-hub-stt.cjs',
